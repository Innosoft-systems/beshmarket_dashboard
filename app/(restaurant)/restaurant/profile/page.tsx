...
export default async function RestaurantProfilePage() {
  ...
  try {
    const [restaurantResponse, workingHoursResponse] = await Promise.all([
      apiRequest<Restaurant>("/restaurants/my", { accessToken: token }),
      apiRequest<WorkingHours[]>("/restaurants/my/working-hours", { accessToken: token }),
    ])
  ...
  if (!restaurant) throw new Error("Restoran ma'lumotlari olinmadi")
