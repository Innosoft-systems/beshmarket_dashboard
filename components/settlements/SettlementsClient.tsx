  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="rounded-xl border border-yellow-300 bg-background p-4 space-y-1">
        ...
        <div className="rounded-xl border border-green-300 bg-background p-4 space-y-1">
